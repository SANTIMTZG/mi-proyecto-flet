...
# 1. LISTA DE PRODUCTOS (Nombres exactos de tu carpeta assets)
productos_datos = [
...
def main(page: ft.Page):
    ...
    # --- DISEÑO DE LA GALERÍA DE PRODUCTOS ---
    ...
    page.add(
        ft.Text("Catálogo Tecnológico 🚀", size=32, weight="bold"),
        galeria,
...
if __name__ == "__main__":
    # Importante para que Render detecte la app
