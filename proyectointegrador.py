...
# =========================
# 1. MODELO DE DATOS (Nombres exactos de tu GitHub)
# =========================
productos_datos = [
    {"n": "Laptop Gamer", "p": 25000, "i": "Laptop Gamer.png"},
    {"n": "Smartphone", "p": 15000, "i": "Smartphone.png"},
    {"n": "Audífonos", "p": 1200, "i": "Audífonos.png"}, # Con acento como en tu captura
...
def main(page: ft.Page):
    ...
    def actualizar_carrito_ui():
        # Limpiamos la lista visual y la rellenamos con lo que hay en el arreglo
    ...
    for p in productos_datos:
        galeria.controls.append(
            ft.Container(
                content=ft.Column([
                    # Forzamos la ruta a la carpeta assets
                    ft.Image(
                        src=f"{p['i']}", 
                        width=140, 
                        height=140,
...
if __name__ == "__main__":
    # Render usa la variable PORT para exponer la app
    port = int(os.getenv("PORT", 8550))
    ft.app(
        target=main,
        assets_dir="assets", # <--- Muy importante: apunta a tu carpeta de GitHub
        port=port,
        host="0.0.0.0"
    )